      ...
      module Edit
        ...
        module ClassMethods
          ...
          def resource_defined
            logger.debug("Actionizer::Extensions::PathAndUrlHelpers::Edit.resource_defined") if Actionizer.debug?
            define_edit_url_and_path_helpers
            super if defined?(super)
          end

          def define_edit_url_and_path_helpers
            logger.debug("Actionizer::Extensions::PathAndUrlHelpers::Edit.define_edit_url_and_path_helpers") if Actionizer.debug?
            ...
            instance_url_method = "edit_#{self.instance_name}_url".to_sym
            instance_path_method = "edit_#{self.instance_name}_path".to_sym
